...
const NewWalletButton = ({ bgColor }) => {
  ...
  return (
    <div
      style={buttonStyle}
      className="flex items-center justify-center cursor-pointer svg-glow"
    >
      <svg
        width="68"
        height="69"
      ...
      >
        ...
        <path
          d="M46.9292 1.64062H21.0707C9.98595 1.64062 1 10.6266 1 21.7113V47.5698C1 58.6545 9.98595 67.6405 21.0707 67.6405H46.9292C58.014 67.6405 66.9999 58.6545 66.9999 47.5698V21.7113C66.9999 10.6266 58.014 1.64062 46.9292 1.64062Z"
          stroke="url(#paint1_linear_555_5586)"
          stroke-opacity="0.75"
          stroke-width="2"
        />
        <path
