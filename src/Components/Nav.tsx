...
export default function Nav() {
  ...
  const { dappName, logo, setShowOnboarding } = useContext(NavContext)
  ...
  return (
    ...
    <div className='dark:bg-fontLightColor' >
      <div className="w-[416px] justify-between items-start inline-flex">
        ...
        <div className="p-3 cursor-pointer rounded-[39px] flex-col justify-center  items-center gap-2 inline-flex">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
