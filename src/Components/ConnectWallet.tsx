            ...
            <button onClick={() => { navigate("/connectWallet") }}>
              <div className="w-7 h-7 relative bg-blue-600 rounded-md border">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M14 23.8002C19.4123 23.8002 23.8 19.4126 23.8 14.0002C23.8 8.5878 19.4123 4.2002 14 4.2002C8.58756 4.2002 4.19995 8.5878 4.19995 14.0002C4.19995 19.4126 8.58756 23.8002 14 23.8002ZM11.55 10.8002C11.1357 10.8002 10.8 11.136 10.8 11.5502V16.4502C10.8 16.8644 11.1357 17.2002 11.55 17.2002H16.45C16.8642 17.2002 17.2 16.8644 17.2 16.4502V11.5502C17.2 11.136 16.8642 10.8002 16.45 10.8002H11.55Z" fill="white" />
                </svg>
